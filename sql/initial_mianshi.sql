...
VALUES (1, 'user1', 'b046801f70b001e5dbf8a2a34ce9c682', 'unionId1', 'mpOpenId1', 'user1',
        'https://www.code-nav.cn/logo.png', '喜欢编程的小白', 'user'),
       (2, 'user2', 'b046801f70b001e5dbf8a2a34ce9c682', 'unionId2', 'mpOpenId2', 'user2',
        'https://www.code-nav.cn/logo.png', '全栈开发工程师', 'user'),
       (3, 'user3', 'b046801f70b001e5dbf8a2a34ce9c682', 'unionId3', 'mpOpenId3', 'user3',
        'https://www.code-nav.cn/logo.png', '前端爱好者', 'user'),
       (4, 'user4', 'b046801f70b001e5dbf8a2a34ce9c682', 'unionId4', 'mpOpenId4', 'user4',
        'https://www.code-nav.cn/logo.png', '后端开发工程师', 'user'),
       (5, 'tclsy', 'b046801f70b001e5dbf8a2a34ce9c682', NULL, NULL, 'tcl', 'https://www.code-nav.cn/logo.png',
        '系统管理员', 'admin');
